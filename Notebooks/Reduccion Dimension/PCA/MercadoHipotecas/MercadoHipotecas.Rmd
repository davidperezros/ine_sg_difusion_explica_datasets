...
3. **Descomposición de la matriz**: Utiliza rmétodos matemáticos como la descomposición de valores propios (eigenvalues) y vectores propios (eigenvectors) para obtener los componentes principales. Esto se puede realizar mediante técnicas como la descomposición en valores singulares (SVD) o métodos específicos de librerías.

4. **Selección de componentes**: Examinar los valores propios para decidir cuántos componentes principales retendrás. Los valores propios más grandes indican una mayor variabilidad explicada por esos componentes.
...
1-3) **Calculamos los coeficientes de la ecuación para cada componente principal**
