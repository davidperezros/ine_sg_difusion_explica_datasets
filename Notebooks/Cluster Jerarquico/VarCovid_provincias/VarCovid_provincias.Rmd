...
colnames(datos)<-c( "provincia","1Ola","2Ola")



# Gráfico de puntos
g1<- ggplot(datos, aes(1Ola, 2Ola, label=provincia))+ geom_point(aes(colour = factor(sub1)))+geom_text(hjust=0, vjust=0, size = 2,aes(colour = factor(sub1)))+labs(colour="Clusters")
