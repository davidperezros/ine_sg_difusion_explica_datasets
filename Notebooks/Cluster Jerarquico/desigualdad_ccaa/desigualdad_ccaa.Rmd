...
**Salmedmuj** y **Salmedhom**. Concretamente usaremos un cluster jerárquico.
...
Podemos observar que las agrupaciones, así como el escalado, no se ha hecho tanto por diferencia salarial entre hombre y mujeres y sí por cuantía salarial en las diferentes comunidades, para estudiarlo sería mejor ver porcentajes que muestren las diferencias. A pesar de ello, podemos destacar que en el cluster verde se agrupan las comunidades con menor salario medio y en el cluster morado las de mayor salario medio en hombres y mujeres. Por medio, se situan el cluster azul y el cluster rojo, este último es levemente superior.
